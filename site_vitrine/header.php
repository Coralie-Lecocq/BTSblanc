...
<header class="header" id="header">
		<div class="container">
			<div class="w3l_login">
				<a href="?page=login" data-toggle="modal" data-target="#myModal88"><span class="glyphicon glyphicon-user" aria-hidden="true"></span></a>
			</div>
			<div class="w3l_logo">
				<h1><a href="?page=home">Chiiiiiiiiiiize<span>Print your life</span></a></h1>
			</div>
			<div class="search">
